...
@section('content')
    @php
        $dateTime = \Carbon\Carbon::parse($data['created_at'])->format('Y-m-d');
    @endphp
    <section class="blog-details-hero set-bg" data-setbg="/upload/admin/blogs/{{ $data['image'] }}"
        style="background-image: url(&quot;/upload/admin/blogs/{{ $data['image'] }}&quot;);">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="bd-hero-text">
                        ...
                        <h2>{{ $data['title'] }}</h2>
                        <ul>
                            <li class="b-time"><i class="icon_clock_alt"></i> {{ $dateTime }}</li>
