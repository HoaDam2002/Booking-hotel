                                    ...
                                    <div class="row">
                                        <div class="col-md-4 order-md-2 mb-4">
                                            <h4 class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="text-muted">Your Room</span>
                                            ...
                                            <ul class="list-group mb-3">
                                                <li class="list-group-item d-flex justify-content-between lh-condensed">
                                                    <div>
                                                        ...
                                                        <small class="text-muted">Luxury Room</small>
                                                    </div>
                                                </li>
                                                <li class="list-group-item d-flex justify-content-between lh-condensed">
                                                    <div>
                                                        <h6 class="my-0">Checkin - Checkout</h6>
                                                        <small class="text-muted">16/12/2023 - 17/12/2023</small>
                                                    </div>
                                                </li>
                                                {{-- <li class="list-group-item d-flex justify-content-between lh-condensed">
                                                    <div>
