            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                            ...
                            @if(isset($data))
                                @foreach ($data as $value)
                                    <tr>
                                        ...
                                        <td>
                                            <div><a href="{{url('admin/editbrand/'.$value->id)}}"> <i class="mdi mdi-lead-pencil"></i> Edit</a></div>
                                            <div>
                                                <a href="{{url('admin/deletebrand/'.$value->id)}}"><i class="mdi mdi-delete">Delete</i></a>
                                            </div>
                                        </td>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <a href="{{url('admin/addbrand')}}"><button class="btn btn-success">Add Brand</button></a>
